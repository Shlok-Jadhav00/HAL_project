# AEIA - AI-Powered Engineering Insight Assistant (HAL_project)
...
- **config/, ules/, database/schema.sql, equirements.txt** - ready-to-use seed files, already
...
5. core/, gui/, database/*.py, and 	ests/ are intentionally not scaffolded yet - that's the
